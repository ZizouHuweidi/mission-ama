...
func (m *UserMutation) AddMissionIDs(ids ...int) {
	if m.missions == nil {
...
func (m *UserMutation) RemoveMissionIDs(ids ...int) {
...
func (m *UserMutation) RemovedMissionsIDs() (ids []int) {
...
func (m *UserMutation) MissionsIDs() (ids []int) {
